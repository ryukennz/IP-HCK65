export default function HomeHero() {
    return (
        <>
  <section className="relative bg-[url(https://wallpaperaccess.com/download/1920x1080-cat-5922661)] bg-cover bg-center bg-no-repeat">
    ...
    <div className="relative max-w-screen-xl px-4 py-32 mx-auto sm:px-6 lg:flex lg:h-screen lg:items-center lg:px-8">
      <div className="max-w-xl text-center ltr:sm:text-left rtl:sm:text-right">
        ...
        <p className="max-w-lg mt-4 sm:text-xl/relaxed text-secondary">
          Keep in mind, most of this cats will bite you if they aint like your smell.
        </p>
      </div>
    </div>
  </section>
